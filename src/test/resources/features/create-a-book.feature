Feature: Create a book
  ...
  Rule: data must be valid
    Scenario Outline: Title is mandatory and can't be longer than 30 characters
      When I create a book titled "<title>" published in 1951 for author 9d628ae3-4147-4f6e-91d4-3851be1af7c6
    ...
    Scenario Outline: Author's identifier is mandatory and is a UUID
      When I create a book titled "Foundation" published in 1951 for author <author identifier>
      Then an error is raised with message "<error message>"
      Examples:
  ...
  Rule: the book's author must exists
    Example: the author doesn't exists
      When I create a book titled "Foundation" published in 1951 for author da7557ff-9236-46db-90f7-074029dae4ad
    ...
    Example: the author already exists
      When I create a book titled "Foundation" published in 1951 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac
      Then the book "Foundation" published in 1951 is created with its unique identifier 1160aed8-eb2f-4fb3-92e4-43480fff64f5 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac
  ...
  Rule: a book must not already exists for an author
    ...
    Example: the book already exists for the author
      Given the book "Foundation" published in 1951 with its unique identifier 1160aed8-eb2f-4fb3-92e4-43480fff64f5 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac
      When I create a book titled "Foundation" published in 1951 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac
    ...
    Example: the book already exists for another author
      Given the book "Foundation" published in 1951 with its unique identifier 1160aed8-eb2f-4fb3-92e4-43480fff64f5 for author 589a0b4c-93b8-4f46-8c7e-02794a8c252e
      When I create a book titled "Foundation" published in 1951 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac
      Then the book "Foundation" published in 1951 is created with its unique identifier 1160aed8-eb2f-4fb3-92e4-43480fff64f5 for author 8bb4daf7-3c5c-4f62-a416-99be9ae3a9ac